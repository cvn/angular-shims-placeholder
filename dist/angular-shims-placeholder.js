/*! angular-shims-placeholder - v0.4.2 - 2015-06-08
...
.directive('placeholder', placeholderDirective('placeholder'))
.directive('ngAttrPlaceholder', placeholderDirective('ngAttrPlaceholder'));

function placeholderDirective(attrName){
return /* @ngInject */ ["$timeout", "$document", "$interpolate", "$injector", "placeholderSniffer", function($timeout, $document, $interpolate, $injector, placeholderSniffer) {
		...
		link: function(scope, elem, attrs, ngModel) {
			...
			if (!ngModel) {
				elem.bind('change', function () {
					changePlaceholder($interpolate(elem.attr(attrName))(scope));
				});
			}
