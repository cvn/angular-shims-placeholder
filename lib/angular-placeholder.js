	...
	return {
		...
		link: function(scope, elem, attrs, ngModel) {
			...
			function setupPasswordPlaceholder() {
				clone = angular.element('<input type="text"/>').attr(
			...
			function showPasswordPlaceholder() {
				...
				clone
					.val(text) // force placeholder text
					.attr('class', elem.attr('class') || '') // copy classes
					.attr('style', elem.attr('style') || '') // copy styles
					.removeClass('ng-hide');
			}
